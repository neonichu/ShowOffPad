...
@property (nonatomic,assign,setter=setUploadProgressDelegate:) id uploadProgressDelegate;
@property (nonatomic,assign,setter=setDownloadProgressDelegate:) id downloadProgressDelegate;
